...
HD_PWD='/home/rahul24/ICDesign/scripting-and-automation1/Automation/Project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_Wallace_Multiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_Wallace_Multiplier.tcl
