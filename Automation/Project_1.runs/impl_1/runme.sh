...
HD_PWD='/home/rahul24/ICDesign/scripting-and-automation1/Automation/Project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_Wallace_Multiplier.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_Wallace_Multiplier.tcl -notrace
